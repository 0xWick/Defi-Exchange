...
/**
 * removeLiquidity: Removes the `removeLPTokenWei` amoung of LP tokens from
...
/**
 * getTokensAfterRemove: Calculates the amoung of `Ether` and `CD` tokens
 * that would be returend back to user after he removes `removeLPTokenWei` amount
